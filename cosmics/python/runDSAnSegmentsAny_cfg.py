...
from Firefighter.cosmics.CosmicDSFiles import allfiles
_event_runover = 100000 # -1
_report_every = 1000
...
# _data_runover = ['file:/uscmst1b_scratch/lpc1/3DayLifetime/wsi/19C3CFD7-4E31-CC42-871C-246493D956F7.root']
_data_runover = allfiles

_output_fname = 'DSAnSegmentsAny.root'
...
## analyzer
process.ana = cms.EDAnalyzer("DSAnSegmentsAny")
