...
from Firefighter.recoStuff.MCGeometryFilter_cfi import mcgeometryfilter as _mcgeometryfilter
from Firefighter.recoStuff.MCKinematicFilter_cfi import mckinematicfilter as _mckinematicfilter
...
filteringDsaMuAsPFCand = cms.Sequence(mcGeometryFilter + mcKinematicFilter +
                                      selectedDsaMuons + dsaMuPFCand +
                                      dsaMuPFCandFork)
