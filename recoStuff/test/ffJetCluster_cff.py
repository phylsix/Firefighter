...
mod = {
    ...
    'PFJetsConstituentsColon' : mod["PFJets"]+'Constituents:constituents', # ak4PFJetsCombConstituents:constituents
...
jetSeq = cms.Sequence(
    ...
    + process.ak4PFJetsComb
    + process.ak4PFJetsCombConstituents
)