...
ff::GeometryBoundary::GeometryBoundary( float eta, float r )
    : fMinEta( -fabs( eta ) ),
      ...
      fMinRadius( 0. ),
      fMaxRadius( r ),
      fMinZ( r * sinh( fMinEta ) ),
      fMaxZ( r * sinh( fMaxEta ) ) {}
...
ff::GeometryBoundary::GeometryBoundary( float mineta,
                                        float maxeta,
                                        float minr,
                                        float maxr,
                                        float minz,
    ...
    : fMinEta( mineta ),
      ...
      fMinZ( minz ),
      fMaxZ( maxz ) {
  assert( fMinEta < fMaxEta && fMinRadius < fMaxRadius && fMinZ < fMaxZ );
}
