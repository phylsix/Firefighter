...
alias fftestsig4mu='cmsRun $FFCFG config=$TESTCONFIGBASE/ffSuperConfig_signal-4mu.yml'
alias fftestsig2mu2e='cmsRun $FFCFG config=$TESTCONFIGBASE/ffSuperConfig_signal-4mu.yml'
