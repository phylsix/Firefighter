#!/usr/bin/env python
"""submit jobs in group of *data*, *bkg*
...
usage: python ffGrandJobSubmitter.py bkgmc -s crab
...
if __name__ == "__main__":
    ...
    print(" I am Mr. ffSkimGrandJobSubmitter ".center(79, '+'))
