...
SOURCEEOSPATH = "/store/group/lpcmetx/SIDM/Skim/proxy/2018"
...
if __name__ == "__main__":
    ...
    with open('description.json', 'w') as f:
        f.write(json.dumps(sorted(
            [join('src/Firefighter/ffConfig/python/production/SkimProxy18/data', dtag + '.yml') for dtag in datasetlist]
            ), indent=4))
