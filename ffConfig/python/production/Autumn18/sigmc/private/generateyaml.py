...
from Firefighter.ffConfig.datasetUtils import ffdatasetsignal
...
if __name__ == "__main__":
    ...
    with open('description.json', 'w') as f:
        f.write(json.dumps(sorted(
            [join('src/Firefighter/ffConfig/python/production/Autumn18/sigmc/private/', dtag + '.yml') for dtag in datasets]
            ), indent=4))
