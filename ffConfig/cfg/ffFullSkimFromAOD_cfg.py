...
from Firefighter.ffConfig.ffChainConstruction import skimFullEvents

options = VarParsing.VarParsing("analysis")
configDefault = join(os.getenv("CMSSW_BASE"), "src/Firefighter/ffConfig/cfg/ffSuperConfig.yml")
options.register(
    "config",
    configDefault,
