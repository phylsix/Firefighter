...
ffNtupleDsaMuon::initialize( TTree&                   tree,
  ...
  dsamuon_token_     = cc.consumes<reco::TrackCollection>(
...
ffNtupleDsaMuon::fill( const edm::Event& e, const edm::EventSetup& es ) {
  ...
  for ( const auto& dsamuon : dsamuons ) {
    ...
    dsamuon_p4_.push_back( useMuonHypothesis_
                               ? LorentzVector( dsamuon.px(), dsamuon.py(),
                                                dsamuon.pz(),
                                                hypot( dsamuon.p(), M_Mu ) )
                               : LorentzVector( dsamuon.px(), dsamuon.py(),
                                                dsamuon.pz(), dsamuon.p() ) );
    dsamuon_normChi2_.emplace_back(
        ( dsamuon.ndof() != 0 ) ? dsamuon.normalizedChi2() : NAN );
    ...
    dsamuon_ptErr_.emplace_back( ( dsamuon.charge() != 0 ) ? dsamuon.ptError()
                                                           : NAN );
