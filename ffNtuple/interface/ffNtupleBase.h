...
class ffNtupleBase
{
  public:
    ...
    virtual void fill(const edm::Event&, const edm::EventSetup&, HLTConfigProvider&) = 0;
...
using ffNtupleFactory = edmplugin::PluginFactory<ffNtupleBase* (const edm::ParameterSet&)>;
