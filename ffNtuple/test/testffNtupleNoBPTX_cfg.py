...
dataType = "NoBPTXSkim"  # sys.argv[2]
TEST_FAST = True
if "full" in sys.argv:
    TEST_FAST = False
...
process.ntuple_muontiming.src = cms.InputTag("muonsFromdSA")

process.ntuple_step = cms.Path(process.noBPTXSkimMuonTimeSeq + process.ffNtuplesSeq)
