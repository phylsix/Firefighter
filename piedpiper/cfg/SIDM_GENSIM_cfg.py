...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Firefighter/piedpiper/python/externalLHEProducer_and_PYTHIA8_Hadronizer_cff.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SIDM_GENSIM.root'),
