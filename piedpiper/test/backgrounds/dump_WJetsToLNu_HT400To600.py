...
bkgType = 'WJetsToLNu_HT400To600'

# WJetsToLNu_HT400To600
fn = 'root://cmsxrootd.fnal.gov//store/mc/RunIIAutumn18DRPremix/WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8/AODSIM/102X_upgrade2018_realistic_v15-v1/90000/FE3914C6-7FEE-DD45-89E9-E0C60FA1640F.root'
events = Events(fn)
...
for i, event in enumerate(events, 1):
    ...
    if i%1000 == 1: print("{} Event : {}".format(bkgType, i))
    # if i>50: break
...
# ax.hist(np.array(res_pt[6]), bins=50, range=[0, 500], histtype='step', normed=True, label='gen t')
...
# ax.hist(np.array(res_eta[6]), bins=50, range=[-6, 6], histtype='step', normed=True, label='gen t')
...
# ax.hist(np.array(res_phi[6]), bins=50, range=[-3.142, 3.142], histtype='step', normed=True, label='t')
